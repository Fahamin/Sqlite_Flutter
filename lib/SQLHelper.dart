...
class SQLHelper {
   static final DATABASE_NAME = "diary";
   static final VERSTION = 1;
   static final TABLE_NAME = "items";

   static final COL_1 = "id";
   static final COL_2 = "title";
   static final COL_3 = "description";
   static final COL_4 = "createdAt";
  ...
  static Future<void> createTables(sql.Database database) async {
    String CREATE_TABLE_QUERY = "CREATE TABLE "
        ...
        + COL_2 + " TEXT,"
        + COL_3 + " TEXT,"
        + COL_4 + " TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP"+ ")";
...
// created_at: the time that the item was created. It will be automatically handled by SQLite
  ...
  static Future<int> createItem(String title, String? descrption) async {
    ...
    final data = {COL_2: title, COL_3: descrption};
